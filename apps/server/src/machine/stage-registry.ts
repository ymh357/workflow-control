...
export type StageBuilderOpts = { blockedTarget?: string; statePrefix?: string; childToGroup?: Map<string, string>; sessionMode?: "multi" | "single"; parallelGroupName?: string; storeSchema?: StoreSchema };
