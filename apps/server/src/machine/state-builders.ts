    ...
    invoke: {
      ...
      input: ({ context }: { context: WorkflowContext }) => {
        ...
        return {
          ...
          tier1Context: buildTier1Context(effectiveContext, runtime, runtime.tier1_max_tokens, stateName, storeSchema),
          enabledSteps,
  ...
  return {
    ...
    invoke: {
      ...
      input: ({ context }: { context: WorkflowContext }) => ({
        ...
        stageName: groupName,
        worktreePath: context.worktreePath ?? "",
        tier1Context: buildTier1Context(context, combinedRuntime, undefined, undefined, storeSchema),
        attempt: context.retryCount,
        resumeInfo: context.resumeInfo,
